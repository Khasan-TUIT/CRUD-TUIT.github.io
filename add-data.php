...
<div class="container">
    ...
    <table class='table table-bordered'>
        ...
        <tr>
            <td>Phone</td><td><input type='text' name='contact_no' class='form-control' required></td>
        </tr>
        <tr>
            <td colspan="2">
            ...
            <i class="glyphicon glyphicon-backward"></i> &nbsp; Return to index</a>
            </td>
        </tr>
    </table>
</form>
